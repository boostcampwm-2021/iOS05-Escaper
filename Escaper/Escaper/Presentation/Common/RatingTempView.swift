...
private extension RatingTempView {
    ...
    func createStarLayer(isFilled: Bool) -> CALayer {
        guard let image = isFilled ? EDSImage.starfilled.value : EDSImage.starunfilled.value else { return CALayer() }

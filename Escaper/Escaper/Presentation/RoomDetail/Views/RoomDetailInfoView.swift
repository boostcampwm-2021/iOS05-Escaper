...
final class RoomDetailInfoView: UIView {
    ...
    func update(room: Room) {
        self.leftInfoView.inject(view: InfoDescriptionRatingStackView(title: "난이도", kind: .lock, rating: Double(room.difficulty)))
        ...
        self.rightInfoView.inject(view: InfoDescriptionRatingStackView(title: "만족도", kind: .star, rating: room.averageSatisfaction))
